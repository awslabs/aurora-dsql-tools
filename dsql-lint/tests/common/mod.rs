...
pub const CLEAN_STATEMENTS: &[(&str, &str, &str, &str)] = &[
    ...
    (
        "alter-add-identity-cache-1",
        "ALTER TABLE _clean_identity_1 ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (CACHE 1);",
        "CREATE TABLE _clean_identity_1 (id BIGINT NOT NULL);",
        "DROP TABLE IF EXISTS _clean_identity_1;",
    ),
    (
        "alter-add-identity-cache-65536",
        "ALTER TABLE _clean_identity_65536 ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (CACHE 65536);",
        "CREATE TABLE _clean_identity_65536 (id BIGINT NOT NULL);",
        "DROP TABLE IF EXISTS _clean_identity_65536;",
    ),
    (
    ...
    (
        ...
        "CREATE TABLE _clean_drop_constraint (id INT, CONSTRAINT _clean_check CHECK (id > 0));",
        "DROP TABLE IF EXISTS _clean_drop_constraint;",
    ),
    (
        ...
        "CREATE TABLE _clean_drop_constraint_if_exists (id INT, CONSTRAINT _clean_check_if_exists CHECK (id > 0));",
        "DROP TABLE IF EXISTS _clean_drop_constraint_if_exists;",
    ),
    (
        "alter-drop-unique-constraint",
        "ALTER TABLE _clean_drop_unique_constraint DROP CONSTRAINT _clean_unique;",
        "CREATE TABLE _clean_drop_unique_constraint (id INT, email TEXT, CONSTRAINT _clean_unique UNIQUE (email));",
        "DROP TABLE IF EXISTS _clean_drop_unique_constraint;",
    ),
    (
        "alter-drop-identity",
        "ALTER TABLE _clean_drop_identity ALTER COLUMN id DROP IDENTITY;",
        "CREATE TABLE _clean_drop_identity (id BIGINT GENERATED BY DEFAULT AS IDENTITY (CACHE 1));",
        "DROP TABLE IF EXISTS _clean_drop_identity;",
    ),
    (
        "alter-drop-identity-if-exists",
        "ALTER TABLE _clean_drop_identity_if_exists ALTER COLUMN id DROP IDENTITY IF EXISTS;",
        "CREATE TABLE _clean_drop_identity_if_exists (id BIGINT GENERATED BY DEFAULT AS IDENTITY (CACHE 1));",
        "DROP TABLE IF EXISTS _clean_drop_identity_if_exists;",
    ),
    (
        "alter-drop-expression",
        "ALTER TABLE _clean_drop_expression ALTER COLUMN normalized DROP EXPRESSION;",
        "CREATE TABLE _clean_drop_expression (name TEXT, normalized TEXT GENERATED ALWAYS AS (lower(name)) STORED);",
        "DROP TABLE IF EXISTS _clean_drop_expression;",
    ),
    (
        "alter-drop-expression-if-exists",
        "ALTER TABLE _clean_drop_expression_if_exists ALTER COLUMN normalized DROP EXPRESSION IF EXISTS;",
        "CREATE TABLE _clean_drop_expression_if_exists (name TEXT, normalized TEXT GENERATED ALWAYS AS (lower(name)) STORED);",
        "DROP TABLE IF EXISTS _clean_drop_expression_if_exists;",
    ),
    (
        "create-expression-index",
        "CREATE INDEX ASYNC _clean_expression_idx ON _clean_base ((lower(name)));",
        "",
        "DROP INDEX IF EXISTS _clean_expression_idx;",
    ),
    (
        "create-arithmetic-expression-index",
        "CREATE INDEX ASYNC _clean_arithmetic_expression_idx ON _clean_base (((id + 1)));",
        "",
        "DROP INDEX IF EXISTS _clean_arithmetic_expression_idx;",
    ),
    (
        "create-index-nulls-first",
        "CREATE INDEX ASYNC _clean_nulls_first_idx ON _clean_base (name NULLS FIRST);",
        "",
        "DROP INDEX IF EXISTS _clean_nulls_first_idx;",
    ),
    (
...
pub const FALSE_POSITIVE_CASES: &[(&str, &str)] = &[
    ...
    // Valid index should not trigger USING or Partial rules
...
pub const ADDITIONAL_ERROR_CASES: &[(&str, &str)] = &[
    ...
    // ASC/DESC are not supported for DSQL index keys.
    ("CREATE INDEX ASYNC idx ON t (col ASC);", "sort direction"),
    ("CREATE INDEX ASYNC idx ON t (col DESC);", "sort direction"),
...
pub const ADDITIONAL_FALSE_POSITIVES: &[(&str, &str)] = &[
    ...
    (
        "ALTER TABLE t ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (CACHE 65536);",
        "ADD GENERATED",
    ),
...
pub fn fixture_for_rule(rule: LintRule) -> Option<RuleFixture> {
    match rule {
        ...
        LintRule::NumericBounds => {
            fix("CREATE TABLE _r (n NUMERIC(1001, 0));", "NUMERIC")
        }
