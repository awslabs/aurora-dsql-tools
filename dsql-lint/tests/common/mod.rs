...
pub fn fixture_for_rule(rule: LintRule) -> Option<RuleFixture> {
    match rule {
        ...
        LintRule::IdentityAddGeneratedCollapse => fix(
            "CREATE TABLE _r (id bigint NOT NULL);\n\
             ALTER TABLE _r ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY \
             (SEQUENCE NAME _r_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1);",
            "made an identity column",
        ),
