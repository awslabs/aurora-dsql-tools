...
public class AuroraDSQLDatabase extends PostgreSQLDatabase {
    ...
    /** Resolved from the build rather than hardcoded, so it cannot drift from build.gradle. */
    static final String PLUGIN_VERSION = resolveVersion();
    ...
    private static String resolveVersion() {
        // version.properties is generated by the build into this class's package.
        try (InputStream in = AuroraDSQLDatabase.class.getResourceAsStream("version.properties")) {
            if (in != null) {
            ...
            // Fall through to the JAR manifest.
        }

        Package pkg = AuroraDSQLDatabase.class.getPackage();
